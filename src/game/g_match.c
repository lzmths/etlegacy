...
void G_printMatchInfo(gentity_t *ent)
{
	...
	for (i = TEAM_AXIS; i <= TEAM_SPECTATOR; i++)
	{
		...
		CP("sc \"\n\"");
#ifdef FEATURE_RATING
		CP("sc \"^7TEAM       Player         ^1 TmX^4 TmL^7 Kll Dth  SK  TK^7 Eff^2    DG^1    DR^6  TDG^4  TDR^3  Score^8  Rating^9   Mean^9   Dev^9   PpX^9   PpL\n\"");
		CP("sc \"^7-------------------------------------------------------------------------------------------^9-------------^9------------\n\"");
#else
		...
		for (j = 0; j < level.numConnectedClients; j++)
		{
			...
			cnt++;
#ifdef FEATURE_RATING
			CP(va("sc \"%-14s %s%-15s^1%4d^4%4d^3%4d%4d%4d%4d%s%4d^2%6d^1%6d^6%5d^4%5d^3%7d^8%8.2f^9%7.2f^9%6.2f^9%6.2f^9%6.2f\n\"",
#else
...
#ifdef FEATURE_RATING
		CP("sc \"^7-------------------------------------------------------------------------------------------^9-------------^9------------\n\"");
		CP(va("sc \"%-14s ^5%-15s^1%4d^4%4d^5%4d%4d%4d%4d^5%4d^2%6d^1%6d^6%5d^4%5d^3%7d^8%8.2f^9%7.2f^9%6.2f^9%6.2f^9%6.2f\n\"",
#else
		CP("sc \"^7-----------------------------------------------------------------------------------\n\"");
